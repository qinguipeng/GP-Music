...
__DEFINE__(1679318856959, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1679318856960,"./event-store":1679318856961}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679318856960, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1679318856961, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1679318856960,"./utils":1679318856962}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679318856962, function(require, module, exports) {
...
return __REQUIRE__(1679318856959);
})()
