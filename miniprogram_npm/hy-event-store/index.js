...
__DEFINE__(1679318856949, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1679318856950,"./event-store":1679318856951}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679318856950, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1679318856951, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1679318856950,"./utils":1679318856952}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679318856952, function(require, module, exports) {
...
return __REQUIRE__(1679318856949);
})()
